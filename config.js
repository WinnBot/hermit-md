...
module.exports = {
    ...
    BOT_NAME: process.env.BOT_NAME || 'Winning Assistant Bot',
    ...
    BOT_INFO: process.env.BOT_INFO || 'Assistant;Botyᴀɴ;2348053782835;https://i.imgur.com/6oRG106.jpeg',
    AUDIO_DATA: process.env.AUDIO_DATA === undefined ? 'Assistant;Botyᴀɴ;https://i.imgur.com/fj2WE83.jpeg' : process.env.AUDIO_DATA,
    STICKER_DATA: process.env.STICKER_DATA === undefined ? 'Assistant;Botyᴀɴ' : process.env.STICKER_DATA,
